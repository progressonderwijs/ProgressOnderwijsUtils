...
namespace ProgressOnderwijsUtilsTests
{
    ...
    public sealed class TreeTest
    {
        ...
        [Test]
        public void BuildDetectsCycles() { Assert.Throws<InvalidOperationException>(() => Tree.Build(0, i => new[] { (i + 1) % 10, (i + 2) % 13 })); }

        [Test]
        public void CanBuildTree1000Deep() { var tree = Tree.Build(0, i => Enumerable.Range(i + 1, 1000 - i)); }
    }
}
