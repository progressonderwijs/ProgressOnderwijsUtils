...
public static class ParameterValuesForDebuggingExtensionTest
{
    ...
    public static void IntParametersCanBeRetrieved()
    {
        ...
        PAssert.That(() => sqlA.ParameterValuesForDebugging().AsEnumerable().SequenceEqual(new object[] { 1, }));
        var sqlB = SQL($"Hello{3}, {2}, {1}");
        PAssert.That(() => sqlB.ParameterValuesForDebugging().AsEnumerable().SequenceEqual(new object[] { 3, 2, 1, }));
    }
    ...
    public static void DateTimeParametersCanBeRetrieved()
    {
        ...
        PAssert.That(() => sql.ParameterValuesForDebugging().AsEnumerable().SequenceEqual(new object[] { new DateTime(2000, 1, 1), }));
    }
    ...
    public static void CurrentTimeTokenIsNotReplaced()
    {
        ...
        PAssert.That(() => sql.ParameterValuesForDebugging().AsEnumerable().SequenceEqual(new object[] { CurrentTimeToken.Instance, }));
    }
}
