...
public sealed record IMaybeAddState<T1, E>(Maybe<T1, E> Acc) : IMaybeAdd<T1, E>
{
    IMaybeAdd<T1, T2, E> IMaybeAdd<T1, E>.WhenOkTryAdd<T2>(Maybe<T2, E> value)
        => new IMaybeAddState<T1, T2, E>(Acc.WhenOkTry(v1 => value.WhenOk(v2 => (v1, v2))));

    IMaybeAdd<T1, T2, E> IMaybeAdd<T1, E>.WhenOkTryAdd<T2>(Func<T1, Maybe<T2, E>> selector)
        => new IMaybeAddState<T1, T2, E>(Acc.WhenOkTry(v1 => selector(v1).WhenOk(v2 => (v1, v2))));

    IMaybeAdd<T1, T2, E> IMaybeAdd<T1, E>.WhenOkAdd<T2>(Func<T1, T2> selector)
        => new IMaybeAddState<T1, T2, E>(Acc.WhenOk(v1 => (v1, selector(v1))));

    IMaybeAdd<T1, E> IMaybeAdd<T1, E>.WhenOk(Func<T1, Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, E>(Acc.WhenOkTry(v1 => check(v1).WhenOk(_ => v1)));

    async Task<IMaybeAdd<T1, T2, E>> IMaybeAdd<T1, E>.WhenOkTryAddAsync<T2>(Func<T1, Task<Maybe<T2, E>>> selector)
        => new IMaybeAddState<T1, T2, E>(await Acc.WhenOkTryAsync(async v1 => (await selector(v1).ConfigureAwait(false)).WhenOk(v2 => (v1, v2))).ConfigureAwait(false));

    async Task<IMaybeAdd<T1, T2, E>> IMaybeAdd<T1, E>.WhenOkAddAsync<T2>(Func<T1, Task<T2>> selector)
        => new IMaybeAddState<T1, T2, E>(await Acc.WhenOkAsync(async v1 => (v1, await selector(v1).ConfigureAwait(false))).ConfigureAwait(false));

    async Task<IMaybeAdd<T1, E>> IMaybeAdd<T1, E>.WhenOkAsync(Func<T1, Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, E>(await Acc.WhenOkTryAsync(async v1 => (await check(v1).ConfigureAwait(false)).WhenOk(_ => v1)).ConfigureAwait(false));

    IMaybeAdd<T1, F> IMaybeAdd<T1, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, F>(Acc.WhenError(selector));

    async Task<IMaybeAdd<T1, F>> IMaybeAdd<T1, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));

    Maybe<T1, E> IMaybeAdd<T1, E>.ToMaybe()
        => Acc;
}

public sealed record IMaybeAddState<T1, T2, E>(Maybe<(T1, T2), E> Acc) : IMaybeAdd<T1, T2, E>
{
    IMaybeAdd<T1, T2, T3, E> IMaybeAdd<T1, T2, E>.WhenOkTryAdd<T3>(Maybe<T3, E> value)
        => new IMaybeAddState<T1, T2, T3, E>(Acc.WhenOkTry(a => value.WhenOk(v3 => (a.Item1, a.Item2, v3))));

    IMaybeAdd<T1, T2, T3, E> IMaybeAdd<T1, T2, E>.WhenOkTryAdd<T3>(Func<(T1, T2), Maybe<T3, E>> selector)
        => new IMaybeAddState<T1, T2, T3, E>(Acc.WhenOkTry(a => selector(a).WhenOk(v3 => (a.Item1, a.Item2, v3))));

    IMaybeAdd<T1, T2, T3, E> IMaybeAdd<T1, T2, E>.WhenOkAdd<T3>(Func<(T1, T2), T3> selector)
        => new IMaybeAddState<T1, T2, T3, E>(Acc.WhenOk(a => (a.Item1, a.Item2, selector(a))));

    IMaybeAdd<T1, T2, E> IMaybeAdd<T1, T2, E>.WhenOk(Func<(T1, T2), Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, T2, E>(Acc.WhenOkTry(a => check(a).WhenOk(_ => a)));

    async Task<IMaybeAdd<T1, T2, T3, E>> IMaybeAdd<T1, T2, E>.WhenOkTryAddAsync<T3>(Func<(T1, T2), Task<Maybe<T3, E>>> selector)
        => new IMaybeAddState<T1, T2, T3, E>(await Acc.WhenOkTryAsync(async a => (await selector(a).ConfigureAwait(false)).WhenOk(v3 => (a.Item1, a.Item2, v3))).ConfigureAwait(false));

    async Task<IMaybeAdd<T1, T2, T3, E>> IMaybeAdd<T1, T2, E>.WhenOkAddAsync<T3>(Func<(T1, T2), Task<T3>> selector)
        => new IMaybeAddState<T1, T2, T3, E>(await Acc.WhenOkAsync(async a => (a.Item1, a.Item2, await selector(a).ConfigureAwait(false))).ConfigureAwait(false));

    async Task<IMaybeAdd<T1, T2, E>> IMaybeAdd<T1, T2, E>.WhenOkAsync(Func<(T1, T2), Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, T2, E>(await Acc.WhenOkTryAsync(async a => (await check(a).ConfigureAwait(false)).WhenOk(_ => a)).ConfigureAwait(false));

    IMaybeAdd<T1, T2, F> IMaybeAdd<T1, T2, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, T2, F>(Acc.WhenError(selector));

    async Task<IMaybeAdd<T1, T2, F>> IMaybeAdd<T1, T2, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, T2, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));

    Maybe<(T1, T2), E> IMaybeAdd<T1, T2, E>.ToMaybe()
        => Acc;
}

public sealed record IMaybeAddState<T1, T2, T3, E>(Maybe<(T1, T2, T3), E> Acc) : IMaybeAdd<T1, T2, T3, E>
{
    IMaybeAdd<T1, T2, T3, T4, E> IMaybeAdd<T1, T2, T3, E>.WhenOkTryAdd<T4>(Maybe<T4, E> value)
        => new IMaybeAddState<T1, T2, T3, T4, E>(Acc.WhenOkTry(a => value.WhenOk(v4 => (a.Item1, a.Item2, a.Item3, v4))));

    IMaybeAdd<T1, T2, T3, T4, E> IMaybeAdd<T1, T2, T3, E>.WhenOkTryAdd<T4>(Func<(T1, T2, T3), Maybe<T4, E>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, E>(Acc.WhenOkTry(a => selector(a).WhenOk(v4 => (a.Item1, a.Item2, a.Item3, v4))));

    IMaybeAdd<T1, T2, T3, T4, E> IMaybeAdd<T1, T2, T3, E>.WhenOkAdd<T4>(Func<(T1, T2, T3), T4> selector)
        => new IMaybeAddState<T1, T2, T3, T4, E>(Acc.WhenOk(a => (a.Item1, a.Item2, a.Item3, selector(a))));

    IMaybeAdd<T1, T2, T3, E> IMaybeAdd<T1, T2, T3, E>.WhenOk(Func<(T1, T2, T3), Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, T2, T3, E>(Acc.WhenOkTry(a => check(a).WhenOk(_ => a)));

    async Task<IMaybeAdd<T1, T2, T3, T4, E>> IMaybeAdd<T1, T2, T3, E>.WhenOkTryAddAsync<T4>(Func<(T1, T2, T3), Task<Maybe<T4, E>>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, E>(await Acc.WhenOkTryAsync(async a => (await selector(a).ConfigureAwait(false)).WhenOk(v4 => (a.Item1, a.Item2, a.Item3, v4))).ConfigureAwait(false));

    async Task<IMaybeAdd<T1, T2, T3, T4, E>> IMaybeAdd<T1, T2, T3, E>.WhenOkAddAsync<T4>(Func<(T1, T2, T3), Task<T4>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, E>(await Acc.WhenOkAsync(async a => (a.Item1, a.Item2, a.Item3, await selector(a).ConfigureAwait(false))).ConfigureAwait(false));

    async Task<IMaybeAdd<T1, T2, T3, E>> IMaybeAdd<T1, T2, T3, E>.WhenOkAsync(Func<(T1, T2, T3), Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, T2, T3, E>(await Acc.WhenOkTryAsync(async a => (await check(a).ConfigureAwait(false)).WhenOk(_ => a)).ConfigureAwait(false));

    IMaybeAdd<T1, T2, T3, F> IMaybeAdd<T1, T2, T3, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, T2, T3, F>(Acc.WhenError(selector));

    async Task<IMaybeAdd<T1, T2, T3, F>> IMaybeAdd<T1, T2, T3, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, T2, T3, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));

    Maybe<(T1, T2, T3), E> IMaybeAdd<T1, T2, T3, E>.ToMaybe()
        => Acc;
}

public sealed record IMaybeAddState<T1, T2, T3, T4, E>(Maybe<(T1, T2, T3, T4), E> Acc) : IMaybeAdd<T1, T2, T3, T4, E>
{
    IMaybeAdd<T1, T2, T3, T4, T5, E> IMaybeAdd<T1, T2, T3, T4, E>.WhenOkTryAdd<T5>(Maybe<T5, E> value)
        => new IMaybeAddState<T1, T2, T3, T4, T5, E>(Acc.WhenOkTry(a => value.WhenOk(v5 => (a.Item1, a.Item2, a.Item3, a.Item4, v5))));

    IMaybeAdd<T1, T2, T3, T4, T5, E> IMaybeAdd<T1, T2, T3, T4, E>.WhenOkTryAdd<T5>(Func<(T1, T2, T3, T4), Maybe<T5, E>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, E>(Acc.WhenOkTry(a => selector(a).WhenOk(v5 => (a.Item1, a.Item2, a.Item3, a.Item4, v5))));

    IMaybeAdd<T1, T2, T3, T4, T5, E> IMaybeAdd<T1, T2, T3, T4, E>.WhenOkAdd<T5>(Func<(T1, T2, T3, T4), T5> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, E>(Acc.WhenOk(a => (a.Item1, a.Item2, a.Item3, a.Item4, selector(a))));

    IMaybeAdd<T1, T2, T3, T4, E> IMaybeAdd<T1, T2, T3, T4, E>.WhenOk(Func<(T1, T2, T3, T4), Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, T2, T3, T4, E>(Acc.WhenOkTry(a => check(a).WhenOk(_ => a)));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, E>> IMaybeAdd<T1, T2, T3, T4, E>.WhenOkTryAddAsync<T5>(Func<(T1, T2, T3, T4), Task<Maybe<T5, E>>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, E>(await Acc.WhenOkTryAsync(async a => (await selector(a).ConfigureAwait(false)).WhenOk(v5 => (a.Item1, a.Item2, a.Item3, a.Item4, v5))).ConfigureAwait(false));

    async Task<IMaybeAdd<T1, T2, T3, T4, T5, E>> IMaybeAdd<T1, T2, T3, T4, E>.WhenOkAddAsync<T5>(Func<(T1, T2, T3, T4), Task<T5>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, E>(await Acc.WhenOkAsync(async a => (a.Item1, a.Item2, a.Item3, a.Item4, await selector(a).ConfigureAwait(false))).ConfigureAwait(false));

    async Task<IMaybeAdd<T1, T2, T3, T4, E>> IMaybeAdd<T1, T2, T3, T4, E>.WhenOkAsync(Func<(T1, T2, T3, T4), Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, T2, T3, T4, E>(await Acc.WhenOkTryAsync(async a => (await check(a).ConfigureAwait(false)).WhenOk(_ => a)).ConfigureAwait(false));

    IMaybeAdd<T1, T2, T3, T4, F> IMaybeAdd<T1, T2, T3, T4, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, T2, T3, T4, F>(Acc.WhenError(selector));

    async Task<IMaybeAdd<T1, T2, T3, T4, F>> IMaybeAdd<T1, T2, T3, T4, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));

    Maybe<(T1, T2, T3, T4), E> IMaybeAdd<T1, T2, T3, T4, E>.ToMaybe()
        => Acc;
}

public sealed record IMaybeAddState<T1, T2, T3, T4, T5, E>(Maybe<(T1, T2, T3, T4, T5), E> Acc) : IMaybeAdd<T1, T2, T3, T4, T5, E>
{
    IMaybeAdd<T1, T2, T3, T4, T5, T6, E> IMaybeAdd<T1, T2, T3, T4, T5, E>.WhenOkTryAdd<T6>(Maybe<T6, E> value)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, E>(Acc.WhenOkTry(a => value.WhenOk(v6 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, v6))));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, E> IMaybeAdd<T1, T2, T3, T4, T5, E>.WhenOkTryAdd<T6>(Func<(T1, T2, T3, T4, T5), Maybe<T6, E>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, E>(Acc.WhenOkTry(a => selector(a).WhenOk(v6 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, v6))));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, E> IMaybeAdd<T1, T2, T3, T4, T5, E>.WhenOkAdd<T6>(Func<(T1, T2, T3, T4, T5), T6> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, E>(Acc.WhenOk(a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, selector(a))));

    IMaybeAdd<T1, T2, T3, T4, T5, E> IMaybeAdd<T1, T2, T3, T4, T5, E>.WhenOk(Func<(T1, T2, T3, T4, T5), Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, E>(Acc.WhenOkTry(a => check(a).WhenOk(_ => a)));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, E>> IMaybeAdd<T1, T2, T3, T4, T5, E>.WhenOkTryAddAsync<T6>(Func<(T1, T2, T3, T4, T5), Task<Maybe<T6, E>>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, E>(await Acc.WhenOkTryAsync(async a => (await selector(a).ConfigureAwait(false)).WhenOk(v6 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, v6))).ConfigureAwait(false));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, E>> IMaybeAdd<T1, T2, T3, T4, T5, E>.WhenOkAddAsync<T6>(Func<(T1, T2, T3, T4, T5), Task<T6>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, E>(await Acc.WhenOkAsync(async a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, await selector(a).ConfigureAwait(false))).ConfigureAwait(false));

    async Task<IMaybeAdd<T1, T2, T3, T4, T5, E>> IMaybeAdd<T1, T2, T3, T4, T5, E>.WhenOkAsync(Func<(T1, T2, T3, T4, T5), Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, E>(await Acc.WhenOkTryAsync(async a => (await check(a).ConfigureAwait(false)).WhenOk(_ => a)).ConfigureAwait(false));

    IMaybeAdd<T1, T2, T3, T4, T5, F> IMaybeAdd<T1, T2, T3, T4, T5, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, F>(Acc.WhenError(selector));

    async Task<IMaybeAdd<T1, T2, T3, T4, T5, F>> IMaybeAdd<T1, T2, T3, T4, T5, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));

    Maybe<(T1, T2, T3, T4, T5), E> IMaybeAdd<T1, T2, T3, T4, T5, E>.ToMaybe()
        => Acc;
}

public sealed record IMaybeAddState<T1, T2, T3, T4, T5, T6, E>(Maybe<(T1, T2, T3, T4, T5, T6), E> Acc) : IMaybeAdd<T1, T2, T3, T4, T5, T6, E>
{
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.WhenOkTryAdd<T7>(Maybe<T7, E> value)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(Acc.WhenOkTry(a => value.WhenOk(v7 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, v7))));
    ...
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.WhenOkTryAdd<T7>(Func<(T1, T2, T3, T4, T5, T6), Maybe<T7, E>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(Acc.WhenOkTry(a => selector(a).WhenOk(v7 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, v7))));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.WhenOkAdd<T7>(Func<(T1, T2, T3, T4, T5, T6), T7> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(Acc.WhenOk(a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, selector(a))));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.WhenOk(Func<(T1, T2, T3, T4, T5, T6), Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, E>(Acc.WhenOkTry(a => check(a).WhenOk(_ => a)));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.WhenOkTryAddAsync<T7>(Func<(T1, T2, T3, T4, T5, T6), Task<Maybe<T7, E>>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(await Acc.WhenOkTryAsync(async a => (await selector(a).ConfigureAwait(false)).WhenOk(v7 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, v7))).ConfigureAwait(false));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.WhenOkAddAsync<T7>(Func<(T1, T2, T3, T4, T5, T6), Task<T7>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(await Acc.WhenOkAsync(async a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, await selector(a).ConfigureAwait(false))).ConfigureAwait(false));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6), Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, E>(await Acc.WhenOkTryAsync(async a => (await check(a).ConfigureAwait(false)).WhenOk(_ => a)).ConfigureAwait(false));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, F> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, F>(Acc.WhenError(selector));

    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, F>> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));

    Maybe<(T1, T2, T3, T4, T5, T6), E> IMaybeAdd<T1, T2, T3, T4, T5, T6, E>.ToMaybe()
        => Acc;
}

public sealed record IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(Maybe<(T1, T2, T3, T4, T5, T6, T7), E> Acc) : IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>
{
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.WhenOkTryAdd<T8>(Maybe<T8, E> value)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E>(Acc.WhenOkTry(a => value.WhenOk(v8 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, v8))));
    ...
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.WhenOkTryAdd<T8>(Func<(T1, T2, T3, T4, T5, T6, T7), Maybe<T8, E>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E>(Acc.WhenOkTry(a => selector(a).WhenOk(v8 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, v8))));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.WhenOkAdd<T8>(Func<(T1, T2, T3, T4, T5, T6, T7), T8> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E>(Acc.WhenOk(a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, selector(a))));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.WhenOk(Func<(T1, T2, T3, T4, T5, T6, T7), Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(Acc.WhenOkTry(a => check(a).WhenOk(_ => a)));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.WhenOkTryAddAsync<T8>(Func<(T1, T2, T3, T4, T5, T6, T7), Task<Maybe<T8, E>>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E>(await Acc.WhenOkTryAsync(async a => (await selector(a).ConfigureAwait(false)).WhenOk(v8 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, v8))).ConfigureAwait(false));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.WhenOkAddAsync<T8>(Func<(T1, T2, T3, T4, T5, T6, T7), Task<T8>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E>(await Acc.WhenOkAsync(async a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, await selector(a).ConfigureAwait(false))).ConfigureAwait(false));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6, T7), Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(await Acc.WhenOkTryAsync(async a => (await check(a).ConfigureAwait(false)).WhenOk(_ => a)).ConfigureAwait(false));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, F> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, F>(Acc.WhenError(selector));

    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, F>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));

    Maybe<(T1, T2, T3, T4, T5, T6, T7), E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>.ToMaybe()
        => Acc;
}

public sealed record IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E>(Maybe<(T1, T2, T3, T4, T5, T6, T7, T8), E> Acc) : IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>
{
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.WhenOkTryAdd<T9>(Maybe<T9, E> value)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>(Acc.WhenOkTry(a => value.WhenOk(v9 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, v9))));
    ...
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.WhenOkTryAdd<T9>(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Maybe<T9, E>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>(Acc.WhenOkTry(a => selector(a).WhenOk(v9 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, v9))));
    ...
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.WhenOkAdd<T9>(Func<(T1, T2, T3, T4, T5, T6, T7, T8), T9> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>(Acc.WhenOk(a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, selector(a))));
    ...
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.WhenOk(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E>(Acc.WhenOkTry(a => check(a).WhenOk(_ => a)));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.WhenOkTryAddAsync<T9>(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Task<Maybe<T9, E>>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>(await Acc.WhenOkTryAsync(async a => (await selector(a).ConfigureAwait(false)).WhenOk(v9 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, v9))).ConfigureAwait(false));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.WhenOkAddAsync<T9>(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Task<T9>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>(await Acc.WhenOkAsync(async a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, await selector(a).ConfigureAwait(false))).ConfigureAwait(false));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E>(await Acc.WhenOkTryAsync(async a => (await check(a).ConfigureAwait(false)).WhenOk(_ => a)).ConfigureAwait(false));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, F> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, F>(Acc.WhenError(selector));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, F>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));

    Maybe<(T1, T2, T3, T4, T5, T6, T7, T8), E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>.ToMaybe()
        => Acc;
}

public sealed record IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>(Maybe<(T1, T2, T3, T4, T5, T6, T7, T8, T9), E> Acc) : IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>
{
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.WhenOkTryAdd<T10>(Maybe<T10, E> value)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>(Acc.WhenOkTry(a => value.WhenOk(v10 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, a.Item9, v10))));
    ...
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.WhenOkTryAdd<T10>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Maybe<T10, E>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>(Acc.WhenOkTry(a => selector(a).WhenOk(v10 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, a.Item9, v10))));
    ...
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.WhenOkAdd<T10>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), T10> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>(Acc.WhenOk(a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, a.Item9, selector(a))));
    ...
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.WhenOk(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>(Acc.WhenOkTry(a => check(a).WhenOk(_ => a)));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.WhenOkTryAddAsync<T10>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Task<Maybe<T10, E>>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>(await Acc.WhenOkTryAsync(async a => (await selector(a).ConfigureAwait(false)).WhenOk(v10 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, a.Item9, v10))).ConfigureAwait(false));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.WhenOkAddAsync<T10>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Task<T10>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>(await Acc.WhenOkAsync(async a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, a.Item7, a.Item8, a.Item9, await selector(a).ConfigureAwait(false))).ConfigureAwait(false));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>(await Acc.WhenOkTryAsync(async a => (await check(a).ConfigureAwait(false)).WhenOk(_ => a)).ConfigureAwait(false));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, F> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, F>(Acc.WhenError(selector));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, F>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));

    Maybe<(T1, T2, T3, T4, T5, T6, T7, T8, T9), E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>.ToMaybe()
        => Acc;
}

public sealed record IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>(Maybe<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), E> Acc) : IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>
{
    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>.WhenOk(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), Maybe<Unit, E>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>(Acc.WhenOkTry(a => check(a).WhenOk(_ => a)));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>.WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), Task<Maybe<Unit, E>>> check)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>(await Acc.WhenOkTryAsync(async a => (await check(a).ConfigureAwait(false)).WhenOk(_ => a)).ConfigureAwait(false));

    IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, F> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>.WhenError<F>(Func<E, F> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, F>(Acc.WhenError(selector));
    ...
    async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, F>> IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>.WhenErrorAsync<F>(Func<E, Task<F>> selector)
        => new IMaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, F>(await Acc.WhenErrorAsync(selector).ConfigureAwait(false));
