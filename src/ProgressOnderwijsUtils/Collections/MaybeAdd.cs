...
public sealed record MaybeAddState<T1, E> : IMaybeAdd<T1, E>
{
    ...
    public IMaybeAdd<T1, T2, E> WhenOkTryAdd<T2>(Maybe<T2, E> value)
        => new MaybeAddState<T1, T2, E>(maybe.WhenOkTry(v1 => value.WhenOk(v2 => (v1, v2))));

    public IMaybeAdd<T1, T2, E> WhenOkTryAdd<T2>(Func<T1, Maybe<T2, E>> selector)
        => new MaybeAddState<T1, T2, E>(maybe.WhenOkTry(v1 => selector(v1).WhenOk(v2 => (v1, v2))));

    public IMaybeAdd<T1, T2, E> WhenOkAdd<T2>(Func<T1, T2> selector)
        => new MaybeAddState<T1, T2, E>(maybe.WhenOk(v1 => (v1, selector(v1))));

    public IMaybeAdd<T1, E> WhenOk(Func<T1, Maybe<Unit, E>> check)
        => new MaybeAddState<T1, E>(maybe.WhenOkTry(v1 => check(v1).WhenOk(_ => v1)));

    public async Task<IMaybeAdd<T1, T2, E>> WhenOkTryAddAsync<T2>(Func<T1, Task<Maybe<T2, E>>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, E>> WhenOkAddAsync<T2>(Func<T1, Task<T2>> selector)
    ...
    public async Task<IMaybeAdd<T1, E>> WhenOkAsync(Func<T1, Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
...
public sealed record MaybeAddState<T1, T2, E> : IMaybeAdd<T1, T2, E>
{
    ...
    public IMaybeAdd<T1, T2, T3, E> WhenOkTryAdd<T3>(Maybe<T3, E> value)
        => new MaybeAddState<T1, T2, T3, E>(maybe.WhenOkTry(a => value.WhenOk(v3 => (a.Item1, a.Item2, v3))));

    public IMaybeAdd<T1, T2, T3, E> WhenOkTryAdd<T3>(Func<(T1, T2), Maybe<T3, E>> selector)
        => new MaybeAddState<T1, T2, T3, E>(maybe.WhenOkTry(a => selector(a).WhenOk(v3 => (a.Item1, a.Item2, v3))));

    public IMaybeAdd<T1, T2, T3, E> WhenOkAdd<T3>(Func<(T1, T2), T3> selector)
        => new MaybeAddState<T1, T2, T3, E>(maybe.WhenOk(a => (a.Item1, a.Item2, selector(a))));

    public IMaybeAdd<T1, T2, E> WhenOk(Func<(T1, T2), Maybe<Unit, E>> check)
        => new MaybeAddState<T1, T2, E>(maybe.WhenOkTry(a => check(a).WhenOk(_ => a)));

    public async Task<IMaybeAdd<T1, T2, T3, E>> WhenOkTryAddAsync<T3>(Func<(T1, T2), Task<Maybe<T3, E>>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, E>> WhenOkAddAsync<T3>(Func<(T1, T2), Task<T3>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, E>> WhenOkAsync(Func<(T1, T2), Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, T2, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, T2, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, T2, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
...
public sealed record MaybeAddState<T1, T2, T3, E> : IMaybeAdd<T1, T2, T3, E>
{
    ...
    public IMaybeAdd<T1, T2, T3, T4, E> WhenOkTryAdd<T4>(Maybe<T4, E> value)
        => new MaybeAddState<T1, T2, T3, T4, E>(maybe.WhenOkTry(a => value.WhenOk(v4 => (a.Item1, a.Item2, a.Item3, v4))));

    public IMaybeAdd<T1, T2, T3, T4, E> WhenOkTryAdd<T4>(Func<(T1, T2, T3), Maybe<T4, E>> selector)
        => new MaybeAddState<T1, T2, T3, T4, E>(maybe.WhenOkTry(a => selector(a).WhenOk(v4 => (a.Item1, a.Item2, a.Item3, v4))));

    public IMaybeAdd<T1, T2, T3, T4, E> WhenOkAdd<T4>(Func<(T1, T2, T3), T4> selector)
        => new MaybeAddState<T1, T2, T3, T4, E>(maybe.WhenOk(a => (a.Item1, a.Item2, a.Item3, selector(a))));

    public IMaybeAdd<T1, T2, T3, E> WhenOk(Func<(T1, T2, T3), Maybe<Unit, E>> check)
        => new MaybeAddState<T1, T2, T3, E>(maybe.WhenOkTry(a => check(a).WhenOk(_ => a)));

    public async Task<IMaybeAdd<T1, T2, T3, T4, E>> WhenOkTryAddAsync<T4>(Func<(T1, T2, T3), Task<Maybe<T4, E>>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, E>> WhenOkAddAsync<T4>(Func<(T1, T2, T3), Task<T4>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, E>> WhenOkAsync(Func<(T1, T2, T3), Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, T2, T3, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, T2, T3, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, T2, T3, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
...
public sealed record MaybeAddState<T1, T2, T3, T4, E> : IMaybeAdd<T1, T2, T3, T4, E>
{
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, E> WhenOkTryAdd<T5>(Maybe<T5, E> value)
        => new MaybeAddState<T1, T2, T3, T4, T5, E>(maybe.WhenOkTry(a => value.WhenOk(v5 => (a.Item1, a.Item2, a.Item3, a.Item4, v5))));

    public IMaybeAdd<T1, T2, T3, T4, T5, E> WhenOkTryAdd<T5>(Func<(T1, T2, T3, T4), Maybe<T5, E>> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, E>(maybe.WhenOkTry(a => selector(a).WhenOk(v5 => (a.Item1, a.Item2, a.Item3, a.Item4, v5))));

    public IMaybeAdd<T1, T2, T3, T4, T5, E> WhenOkAdd<T5>(Func<(T1, T2, T3, T4), T5> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, E>(maybe.WhenOk(a => (a.Item1, a.Item2, a.Item3, a.Item4, selector(a))));

    public IMaybeAdd<T1, T2, T3, T4, E> WhenOk(Func<(T1, T2, T3, T4), Maybe<Unit, E>> check)
        => new MaybeAddState<T1, T2, T3, T4, E>(maybe.WhenOkTry(a => check(a).WhenOk(_ => a)));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, E>> WhenOkTryAddAsync<T5>(Func<(T1, T2, T3, T4), Task<Maybe<T5, E>>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, E>> WhenOkAddAsync<T5>(Func<(T1, T2, T3, T4), Task<T5>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, E>> WhenOkAsync(Func<(T1, T2, T3, T4), Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, T2, T3, T4, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, T2, T3, T4, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, T2, T3, T4, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
...
public sealed record MaybeAddState<T1, T2, T3, T4, T5, E> : IMaybeAdd<T1, T2, T3, T4, T5, E>
{
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, E> WhenOkTryAdd<T6>(Maybe<T6, E> value)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, E>(maybe.WhenOkTry(a => value.WhenOk(v6 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, v6))));

    public IMaybeAdd<T1, T2, T3, T4, T5, T6, E> WhenOkTryAdd<T6>(Func<(T1, T2, T3, T4, T5), Maybe<T6, E>> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, E>(maybe.WhenOkTry(a => selector(a).WhenOk(v6 => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, v6))));

    public IMaybeAdd<T1, T2, T3, T4, T5, T6, E> WhenOkAdd<T6>(Func<(T1, T2, T3, T4, T5), T6> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, E>(maybe.WhenOk(a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, selector(a))));

    public IMaybeAdd<T1, T2, T3, T4, T5, E> WhenOk(Func<(T1, T2, T3, T4, T5), Maybe<Unit, E>> check)
        => new MaybeAddState<T1, T2, T3, T4, T5, E>(maybe.WhenOkTry(a => check(a).WhenOk(_ => a)));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, E>> WhenOkTryAddAsync<T6>(Func<(T1, T2, T3, T4, T5), Task<Maybe<T6, E>>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, E>> WhenOkAddAsync<T6>(Func<(T1, T2, T3, T4, T5), Task<T6>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, E>> WhenOkAsync(Func<(T1, T2, T3, T4, T5), Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
...
public sealed record MaybeAddState<T1, T2, T3, T4, T5, T6, E> : IMaybeAdd<T1, T2, T3, T4, T5, T6, E>
{
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E> WhenOkTryAdd<T7>(Maybe<T7, E> value)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E> WhenOkTryAdd<T7>(Func<(T1, T2, T3, T4, T5, T6), Maybe<T7, E>> selector)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E> WhenOkAdd<T7>(Func<(T1, T2, T3, T4, T5, T6), T7> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(maybe.WhenOk(a => (a.Item1, a.Item2, a.Item3, a.Item4, a.Item5, a.Item6, selector(a))));

    public IMaybeAdd<T1, T2, T3, T4, T5, T6, E> WhenOk(Func<(T1, T2, T3, T4, T5, T6), Maybe<Unit, E>> check)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, E>(maybe.WhenOkTry(a => check(a).WhenOk(_ => a)));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>> WhenOkTryAddAsync<T7>(Func<(T1, T2, T3, T4, T5, T6), Task<Maybe<T7, E>>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>> WhenOkAddAsync<T7>(Func<(T1, T2, T3, T4, T5, T6), Task<T7>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, E>> WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6), Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
...
public sealed record MaybeAddState<T1, T2, T3, T4, T5, T6, T7, E> : IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>
{
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E> WhenOkTryAdd<T8>(Maybe<T8, E> value)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E> WhenOkTryAdd<T8>(Func<(T1, T2, T3, T4, T5, T6, T7), Maybe<T8, E>> selector)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E> WhenOkAdd<T8>(Func<(T1, T2, T3, T4, T5, T6, T7), T8> selector)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E> WhenOk(Func<(T1, T2, T3, T4, T5, T6, T7), Maybe<Unit, E>> check)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, T7, E>(maybe.WhenOkTry(a => check(a).WhenOk(_ => a)));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>> WhenOkTryAddAsync<T8>(Func<(T1, T2, T3, T4, T5, T6, T7), Task<Maybe<T8, E>>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>> WhenOkAddAsync<T8>(Func<(T1, T2, T3, T4, T5, T6, T7), Task<T8>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, E>> WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6, T7), Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, T7, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
...
public sealed record MaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E> : IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>
{
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E> WhenOkTryAdd<T9>(Maybe<T9, E> value)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E> WhenOkTryAdd<T9>(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Maybe<T9, E>> selector)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E> WhenOkAdd<T9>(Func<(T1, T2, T3, T4, T5, T6, T7, T8), T9> selector)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E> WhenOk(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Maybe<Unit, E>> check)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, E>(maybe.WhenOkTry(a => check(a).WhenOk(_ => a)));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>> WhenOkTryAddAsync<T9>(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Task<Maybe<T9, E>>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>> WhenOkAddAsync<T9>(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Task<T9>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, E>> WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6, T7, T8), Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
...
public sealed record MaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E> : IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>
{
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> WhenOkTryAdd<T10>(Maybe<T10, E> value)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> WhenOkTryAdd<T10>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Maybe<T10, E>> selector)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> WhenOkAdd<T10>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), T10> selector)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E> WhenOk(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Maybe<Unit, E>> check)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>(maybe.WhenOkTry(a => check(a).WhenOk(_ => a)));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>> WhenOkTryAddAsync<T10>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Task<Maybe<T10, E>>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>> WhenOkAddAsync<T10>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Task<T10>> selector)
    ...
    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, E>> WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9), Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
...
public sealed record MaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> : IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>
{
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> WhenOk(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), Maybe<Unit, E>> check)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>(maybe.WhenOkTry(a => check(a).WhenOk(_ => a)));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E>> WhenOkAsync(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), Task<Maybe<Unit, E>>> check)
    ...
    public IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, F> WhenError<F>(Func<E, F> selector)
        => new MaybeAddState<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, F>(maybe.WhenError(selector));

    public async Task<IMaybeAdd<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, F>> WhenErrorAsync<F>(Func<E, Task<F>> selector)
