...
namespace ProgressOnderwijsUtils.Collections
{
    ...
    public struct FastArrayBuilder2<T>
    {
...
#pragma warning restore 169
        ...
        public int Count => (1 << sI + InitSize2Pow - 1) + idx - 1;
        //public T this[int i] 
        //    =>  (uint)i>=(uint)Count  ?throw IndexOutOfRangeException()
        //    : i <InitSize ? Unsafe.Add(ref v00,i)
        //    :  Unsafe.Add(ref a00, Utils.LogBase2RoundedDown(i+1)-InitSize2Pow)
    }

    public struct FastArrayBuilder2b<T>
    {
        const int InitSize2Pow = 4;
...
#pragma warning restore 169
        ...
        public int Count => (1 << sI + InitSize2Pow) + idx;
        //public T this[int i] 
        //    =>  (uint)i>=(uint)Count  ?throw IndexOutOfRangeException()
        //    : i <InitSize ? Unsafe.Add(ref v00,i)
        //    :  Unsafe.Add(ref a00, Utils.LogBase2RoundedDown(i+1)-InitSize2Pow)
    ...
    public struct FastArrayBuilder2c<T>
    {
        const int InitSize2Pow = 4;
        const int InitSize = 1 << InitSize2Pow;
...
#pragma warning restore 169
    ...
    public struct FastArrayBuilder3<T>
    {
