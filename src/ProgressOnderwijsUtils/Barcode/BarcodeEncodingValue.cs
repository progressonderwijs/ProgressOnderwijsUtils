	...
	public static class BarcodeEncodingValue
	{
		...
		public static long Pow(int value)
		{
			...
			switch (value)
			{
				...
				case 2: return 1296;
				case 3: return 46656;
				case 4: return 1679616;
				case 5: return 60466176;
				case 6: return 2176782336; // Deze waarde is groter dan een int32, maar is nodig voor de functie HighestExponent
				default: throw new BarcodeException("Te hoge waarde voor Pow: " + value.ToString(CultureInfo.InvariantCulture));
			}
		}
		...
		public static int Get(char c)
		{
			switch (c)
			{
				...
				case 'Y': return 29;
				case 'Z': return 23;
				default: throw new BarcodeException("Waarde kan niet worden gedecodeerd: " + c.ToString(CultureInfo.InvariantCulture));
			}
		}
