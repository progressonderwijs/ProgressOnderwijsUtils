...
namespace ProgressOnderwijsUtils
{
	...
	{
		readonly static ColumnSort[] EmptyOrder = { };
		...
		[Pure]
		public OrderByColumns FirstSortBy(ColumnSort firstby) { return new OrderByColumns(PrependFiltered(firstby, DirectAcessColumns).ToArray()); }

		[Pure]
		public OrderByColumns ThenSortBy(ColumnSort thenby)
		{
			return DirectAcessColumns.Any(sc => streq(sc.ColumnName, thenby.ColumnName)) ? this
