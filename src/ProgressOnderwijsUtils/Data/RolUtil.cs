...
namespace ProgressOnderwijsUtils
{
	public static class RolUtil
	{
		...
		static RolUtil()
		{
			...
			{
				rollenRelations.Add((int)rol, new RolRelations
				{
					Rol = rol,
		...
		{
			return rollenRelations[(int)rol].IsToekenbaar;
		}

		public static RollenSet OnderliggendeToegangsRollen(this Rol root)
		{
			return new RollenSet(OnderliggendeToegangsRollenImpl(root));
		}
