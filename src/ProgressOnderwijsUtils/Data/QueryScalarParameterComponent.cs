...
namespace ProgressOnderwijsUtils.Data
{
	sealed class QueryScalarParameterComponent : IQueryParameter
	{
		...
		public bool CanShareParamNumberWith(IQueryParameter other) { return ReferenceEquals(this, other) || (other is QueryScalarParameterComponent) && paramval != DBNull.Value && !(paramval is int) && Equals(paramval, ((QueryScalarParameterComponent)other).paramval); }
		public int ParamNumberSharingHashCode() { return paramval.GetHashCode() + (paramval == DBNull.Value || paramval is int ? base.GetHashCode() : 37); }//paramval never null!
