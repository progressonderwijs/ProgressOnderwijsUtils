...
namespace ProgressOnderwijsUtils
{
	...
	public static class Filter
	{
		...
		public static Tuple<FilterBase, string> TryParseSerializedFilterWithLeftovers(string serialized) { return CombinedFilter.Parse(serialized) ?? CriteriumFilter.Parse(serialized); }
